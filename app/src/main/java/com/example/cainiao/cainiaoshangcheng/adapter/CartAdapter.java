package com.example.cainiao.cainiaoshangcheng.adapter;
...
import com.example.cainiao.cainiaoshangcheng.widget.NumberAddView;
...
public class CartAdapter extends SimpleAdapter<ShoppingCart> implements BaseAdapter.OnItemClickListener {
    ...
    protected void convert(BaseViewHolder viewHoder, final ShoppingCart item) {
        ...
        NumberAddView numberAddSubView = (NumberAddView) viewHoder.getView(R.id.num_control);

        numberAddSubView.setValue(item.getCount());

        numberAddSubView.setOnButtonClickListener(new NumberAddView.OnButtonClickListener() {
            @Override

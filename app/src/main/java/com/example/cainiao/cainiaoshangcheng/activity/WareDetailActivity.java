...
public class WareDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Serializable serializable = getIntent().getSerializableExtra(Constans.WARE);
    ...
    private void initWebView(){
        ...
        settings.setBlockNetworkImage(false);//可以加载图片
        settings.setAppCacheEnabled(true);

        mWebView.loadUrl(Constans.WARES_DETAIL);
